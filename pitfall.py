...
if submit:
    ...
    st.write(response)
st.set_page_config(page_title="Navigation Example", page_icon="🌐")

# Main Streamlit page content
st.title("Streamlit Navigation Example")
st.write("Click the button below to navigate to another page.")

# Create a button
if st.button("Go to the other page"):
